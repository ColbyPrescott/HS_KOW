...
enum class HookWaypointPositions {
    grabbedRing = 150, // Reset hook went around the first gear and is ready to speed up
    waitForMogo = 800, // Reset hook is at a position to store the ring, waiting to deposit it onto a mogo
    depositRingOnMogo = 1430, // Reset hook went around the top of the hook mechanism and is now completely horizontal
